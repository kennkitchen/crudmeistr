...
Donate link: https://vinland.tech/products/
Tags:
...
Table Interface Generator provides add, update, list, and search capabilities based on your custom tables without the need for programming.
...
= Why aren't my Post Stickies working after the last update? =

Originally the plugin didn't use custom post types; after version 1.60.0 they were implemented. With this release, the ability to display notes with the old shortcodes have been removed. You'll need to update any existing Post Stickies to use the new format. We apologize for any inconvenience, but this is way better... trust us.
